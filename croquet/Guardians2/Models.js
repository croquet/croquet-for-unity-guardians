...
import { ModelRoot, Actor, AM_OnGrid, mix, AM_Spatial, AM_Behavioral, Behavior, sphericalRandom, v3_add,
    UserManager, User, AM_Avatar, q_axisAngle, toRad } from "@croquet/worldcore-kernel";
...
export class MyModelRoot extends ModelRoot {
    ...
    init(options) {
        ...
        this.subscribe("input", "spaceDown", this.shoot);
    }
